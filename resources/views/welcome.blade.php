    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
        ...
        <a href="https://laravel-news.com" class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-lg ring-1 ring-white/10 transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
            ...
            <div class="pt-3 sm:pt-5">
                ...
                <p class="mt-4 text-sm leading-relaxed">
                    Laravel News is the best place to find news, tutorials, and community-driven resources about the Laravel framework. Stay updated with everything related to Laravel, PHP, and beyond.
                </p>
                <p class="mt-2 text-sm leading-relaxed">
                    <a href="https://laravel-news.com" target="_blank" class="text-[#FF2D20] hover:underline">
                        Visit Laravel News here
                    </a>
                </p>
            </div>
